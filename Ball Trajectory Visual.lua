...
local function updateLobbyState()
    ...
    if lobby ~= isInLobby then
        ...
        -- Vào hoặc ra Lobby đều reset tracker
        clearAndHideAll()
    end
